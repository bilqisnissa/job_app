...
class CategoryScreen extends StatelessWidget {
  ...
  const CategoryScreen({required this.name, required this.imageUrl});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  JobTile(companyName: 'Google', jobPosition: 'Front-End Developer', companyImage: 'assets/images/icon_google.png'),
                  JobTile(companyName: 'Instagram', jobPosition: 'UI Designer', companyImage: 'assets/images/icon_instagram.png'),
                  JobTile(companyName: 'Facebook', jobPosition: 'Data Scientist', companyImage: 'assets/images/icon_facebook.png'),
                ],
              ),
            ),
            Container(
